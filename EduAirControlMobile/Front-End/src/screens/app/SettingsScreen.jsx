...
export default function SettingsScreen({ navigation, route }) {
  ...
  const handleChangeLanguage = async (langCode) => {
    ...
    setSettings((prev) => ({
      ...prev,
      language: langCode === "en" ? "English" : "Espanol",
    }));
  ...
  const handleDateFormatChange = async (newFormat) => {
    ...
    await AsyncStorage.setItem(
      "settings",
      JSON.stringify({ ...newSettings, dateFormat: newFormat }),
    );
  };
  ...
  const handleSavePassword = () => {
    if (!passwordData.current || !passwordData.new || !passwordData.confirm) {
      Alert.alert(
        t("settings.requiredFieldsTitle"),
        t("settings.requiredFieldsMessage"),
      );
      return;
    }
    if (passwordData.new !== passwordData.confirm) {
      Alert.alert(
        ...
        t("settings.passwordMismatchMessage"),
      );
      return;
    }
    if (passwordData.new.length < 6) {
      Alert.alert(
        t("settings.passwordMismatchTitle"),
        t("settings.passwordLengthMessage"),
      );
      return;
    }
    Alert.alert(
      t("settings.passwordSuccessTitle"),
      t("settings.passwordSuccessMessage"),
    );
        ...
        return (
          <>
            <View style={styles.helpSectionTitle}>
              ...
              <Text style={[styles.helpTitle, { color: tc.textPrimary }]}>
                {t("settings.faq")}
              </Text>
            </View>
            <View style={styles.helpItem}>
              <Text style={[styles.helpQuestion, { color: tc.textPrimary }]}>
                {t("settings.faqAddQuestion")}
              </Text>
              <Text style={[styles.helpAnswer, { color: tc.textSecondary }]}>
                {t("settings.faqAddAnswer")}
              </Text>
            </View>
            <View style={styles.helpItem}>
              <Text style={[styles.helpQuestion, { color: tc.textPrimary }]}>
                {t("settings.faqThemeQuestion")}
              </Text>
              <Text style={[styles.helpAnswer, { color: tc.textSecondary }]}>
                {t("settings.faqThemeAnswer")}
              </Text>
            </View>
            <View style={styles.helpItem}>
              <Text style={[styles.helpQuestion, { color: tc.textPrimary }]}>
                {t("settings.faqPasswordQuestion")}
              </Text>
              <Text style={[styles.helpAnswer, { color: tc.textSecondary }]}>
      ...
      case "contact":
        return (
          <>
            ...
            <View style={styles.helpItem}>
              <Text style={[styles.helpIconSmall, { color: tc.textMuted }]}>
                ✉️
              </Text>
              <View style={{ flex: 1 }}>
                <Text style={[styles.helpLabel, { color: tc.textPrimary }]}>
                  {t("settings.email")}
                </Text>
                <Text style={[styles.helpValue, { color: tc.textSecondary }]}>
                  soporte@eduaircontrol.com
                </Text>
              </View>
            </View>
            <View style={styles.helpItem}>
        ...
        return (
          <>
            ...
            <View style={styles.helpList}>
              <Text style={[styles.helpListItem, { color: tc.textSecondary }]}>
                - {t("settings.termsUse")}
              </Text>
              <Text style={[styles.helpListItem, { color: tc.textSecondary }]}>
                - {t("settings.termsData")}
              </Text>
              <Text style={[styles.helpListItem, { color: tc.textSecondary }]}>
                - {t("settings.termsIp")}
              </Text>
      ...
      case "privacy":
        return (
          <>
            ...
            <View style={styles.helpList}>
              <Text style={[styles.helpListItem, { color: tc.textSecondary }]}>
                - {t("settings.privacyNoShare")}
              </Text>
              <Text style={[styles.helpListItem, { color: tc.textSecondary }]}>
                - {t("settings.privacyEncrypted")}
              </Text>
              <Text style={[styles.helpListItem, { color: tc.textSecondary }]}>
                - {t("settings.privacyRights")}
              </Text>
            </View>
          </>
        );
      case "version":
        return (
          <>
            ...
            <View
              style={[
                styles.versionBadgeBase,
                { backgroundColor: `${tc.accent}20`, borderColor: tc.accent },
              ]}
            >
              <Text style={[styles.versionNumber, { color: tc.accent }]}>
                v1.0.0
              </Text>
            </View>
            <Text style={[styles.helpText, { color: tc.textSecondary }]}>
              EduAirControl Mobile App
            </Text>
            <Text style={[styles.versionDate, { color: tc.textMuted }]}>
              {t("settings.versionDate")}
            </Text>
          </>
        );
      default:
    ...
    >
      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            style={styles.row}
            onPress={() => handleDarkModeToggle(!darkMode)}
          >
            <View style={styles.rowLeft}>
              ...
              />
              <Text
                style={[styles.rowLabel, { color: currentColors.textPrimary }]}
              >
                {t("settings.darkMode")}
              </Text>
            </View>
            ...
            >
              <View
                style={[
                  styles.toggleCircle,
                  darkMode && { transform: [{ translateX: 20 }] },
                ]}
              />
            </View>
          </TouchableOpacity>
          ...
          >
            <View style={styles.rowLeft}>
              ...
              <Text
                style={[styles.rowLabel, { color: currentColors.textPrimary }]}
              >
                {t("settings.accessibleTheme")}
              </Text>
            </View>
            <Text
              style={[styles.rowValue, { color: currentColors.textMuted }]}
              numberOfLines={1}
            >
              {themeLabel(accessibilityTheme)}
            </Text>
            <Ionicons
        ...
        >
          ...
          <TouchableOpacity
            style={styles.row}
            onPress={() => handleAutoTimezoneToggle(!autoTimezone)}
          >
            <View style={styles.rowLeft}>
              <Ionicons
                name="time-outline"
            ...
            <View
              style={[
                styles.toggle,
                {
                  backgroundColor: autoTimezone
                    ? `${currentColors.accent}80`
                    : currentColors.borderColor,
                },
              ]}
            >
              <View
                style={[
                  styles.toggleCircle,
                  autoTimezone && { transform: [{ translateX: 20 }] },
                ]}
              />
            </View>
          </TouchableOpacity>
            ...
            >
              ...
              >
                <View
                  style={[
                    styles.toggleCircle,
                    reminders[key] && { transform: [{ translateX: 20 }] },
                  ]}
                />
              </View>
            </TouchableOpacity>
        ...
        >
          ...
          <TouchableOpacity
            style={styles.row}
            onPress={() => togglePrivacy("perfilPublico")}
          >
            <View style={styles.rowLeft}>
              <Ionicons
                name="eye-outline"
            ...
            <View
              style={[
                styles.toggle,
                {
                  backgroundColor: privacy.perfilPublico
                    ? `${currentColors.accent}80`
                    : currentColors.borderColor,
                },
              ]}
            >
              <View
                style={[
                  styles.toggleCircle,
                  privacy.perfilPublico && { transform: [{ translateX: 20 }] },
                ]}
              />
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.row}
            onPress={() => togglePrivacy("compartirDatos")}
          >
            <View style={styles.rowLeft}>
              <Ionicons
            ...
            <View
              style={[
                styles.toggle,
                {
                  backgroundColor: privacy.compartirDatos
                    ? `${currentColors.accent}80`
                    : currentColors.borderColor,
                },
              ]}
            >
              <View
                style={[
                  styles.toggleCircle,
                  privacy.compartirDatos && { transform: [{ translateX: 20 }] },
                ]}
              />
            </View>
          </TouchableOpacity>
          ...
          >
            <View style={[styles.rowLeft, { flex: 1 }]}>
              ...
              />
              <Text style={[styles.rowLabel, { color: currentColors.error }]}>
        ...
        >
          ...
          {[
            ...
            <TouchableOpacity
              key={type}
              style={styles.row}
              onPress={() => setShowHelpModal({ open: true, type })}
            >
              <View style={styles.rowLeft}>
                <Ionicons
                  name={icon}
          ...
          >
            ...
            <View style={styles.inputRow}>
              ...
              >
                <Ionicons
                  name={
                    showPassword.confirm ? "eye-outline" : "eye-off-outline"
                  }
                  size={20}
                  color={currentColors.textMuted}
                />
            ...
            <View style={styles.modalActions}>
              ...
              >
                <Text
                  style={[styles.saveBtnText, { color: currentColors.bgBody }]}
                >
                  {t("common.save")}
                </Text>
              </TouchableOpacity>
          ...
          >
            ...
            {THEMES.map(({ key, labelKey }) => (
              <TouchableOpacity
                ...
                accessibilityState={{ selected: accessibilityTheme === key }}
                style={[
                  styles.themeMenuOption,
                  {
                    backgroundColor:
                      accessibilityTheme === key
                ...
                onPress={() => changeAccessibilityTheme(key)}
              >
                <Ionicons
                  name={
                    accessibilityTheme === key
      ...
      {/* Modal ayuda */}
      <Modal
        visible={showHelpModal.open}
        transparent
        animationType="slide"
        onRequestClose={() => setShowHelpModal({ open: false, type: null })}
      >
        <View style={styles.modalOverlay}>
          <View
            style={[
              styles.modalCard,
              { maxHeight: "80%", backgroundColor: currentColors.bgCard },
            ]}
          >
            <View style={styles.modalHeader}>
              <Ionicons
              ...
              <TouchableOpacity
                onPress={() => setShowHelpModal({ open: false, type: null })}
              >
                <Ionicons
                  name="close"
                  size={22}
