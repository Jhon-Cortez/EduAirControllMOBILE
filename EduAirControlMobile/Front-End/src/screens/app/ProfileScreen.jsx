...
const PROFILE_STORAGE_KEY = "eduair.profile";
...
export default function ProfileScreen({ navigation, route }) {
  ...
  useEffect(() => {
    AsyncStorage.getItem(PROFILE_STORAGE_KEY)
      ...
      .catch((error) => console.warn("Error loading profile:", error));
  }, []);
  ...
  const handleSave = () => {
    const nextProfile = { ...profile, [modal.field]: modal.value };
    setProfile(nextProfile);
    AsyncStorage.setItem(
      PROFILE_STORAGE_KEY,
      JSON.stringify(nextProfile),
    ).catch((error) => console.warn("Error saving profile:", error));
    ...
    >
      ...
      >
        ...
        <View style={styles.avatarSection}>
          ...
          <Text
            style={[styles.profileTitle, { color: currentColors.textMuted }]}
          >
            {profile.title}
          </Text>
          <View
          ...
          >
            ...
            />
            <Text
              style={[styles.emailText, { color: currentColors.textSecondary }]}
            >
              {profile.email}
            </Text>
          </View>
        ...
        {/* Info fields */}
        <Text style={[styles.sectionTitle, { color: currentColors.textMuted }]}>
        ...
        {/* Logout */}
        <TouchableOpacity
          style={[styles.logoutBtn, { borderColor: currentColors.error }]}
      ...
      <Modal visible={modal.open} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            >
              {t("profile.edit", { label: modal.label })}
            </Text>
            <TextInput
              style={[
                styles.modalInput,
              ...
              placeholder={t("profile.placeholder", {
                label: modal.label.toLowerCase(),
              })}
              placeholderTextColor={currentColors.textMuted}
              autoFocus
              keyboardType={
                modal.field ? fieldConfig[modal.field]?.keyboardType : "default"
              }
            />
